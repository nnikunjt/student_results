...
>>>>>>> 332874512b5b10b78ac51e4a00463327635d7165:admin/dashboard.php
    ...
    if(isset($_POST['submit'])){
        session_destroy(); 
       Redirect('http://localhost/student_results/');
    }
?>
    ...
    <body>
        <nav class="navbar navbar-dark navbar-expand-md bg-dark">
            <div class="container-fluid">
                <a href="http://localhost/student_results/index.php" class="navbar-brand">Yash classes</a>
            </div>
            <ul class="navbar-nav">
            <a href="http://localhost/student_results/index.php" type="button" name="logout" class="btn btn-primary " >Log out</a>
        </ul>
        </nav>
        <div class="container-fluid">
            <div class="row">
